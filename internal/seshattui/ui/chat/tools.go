...
import (
	...
	"github.com/KPO-Tech/seshat/internal/seshattui/diff"
	"github.com/KPO-Tech/seshat/internal/seshattui/fsext"
	"github.com/KPO-Tech/seshat/internal/seshattui/hooks"
...
func NewToolMessageItem(
	...
	case "seshat_list_skills":
		item = NewSeshatListSkillsToolMessageItem(sty, toolCall, result, canceled)
	case "seshat_read_skill":
		item = NewSeshatReadSkillToolMessageItem(sty, toolCall, result, canceled)
	case "seshat_validate_skill":
		item = NewSeshatValidateSkillToolMessageItem(sty, toolCall, result, canceled)
	default:
