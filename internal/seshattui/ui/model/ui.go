...
import (
	...
	"github.com/KPO-Tech/seshat/internal/seshattui/agent/notify"
	...
	"github.com/KPO-Tech/seshat/internal/seshattui/ui/completions"
	"github.com/KPO-Tech/seshat/internal/seshattui/ui/dialog"
...
func (m *UI) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case app.UpdateAvailableMsg:
		text := fmt.Sprintf("Seshat update available: v%s → v%s.", msg.CurrentVersion, msg.LatestVersion)
		if msg.IsDevelopment {
			text = fmt.Sprintf("This is a development version of Seshat. The latest version is v%s.", msg.LatestVersion)
		}
		ttl := 10 * time.Second
...
func (m *UI) Draw(scr uv.Screen, area uv.Rectangle) *tea.Cursor {
	...
	if os.Getenv("SESHAT_LAYOUT_DEBUG") != "" {
		if f, err := os.OpenFile("/tmp/seshat_layout.log", os.O_APPEND|os.O_CREATE|os.O_WRONLY, 0644); err == nil {
...
func (m *UI) View() tea.View {
	...
	v.WindowTitle = "seshat " + home.Short(m.com.Workspace.WorkingDir())
...
// renderLogo renders the Seshat logo with the given styles and dimensions.
